...
class ComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Factory $factory)
    {
        ...
        $factory->composer(['index', 'imprint', 'privacy', 'single-incident', 'subscribe.*', 'signup', 'dashboard.settings.theme', 'notifications::email', 'single-schedule', 'errors.*', 'schedules'], ThemeComposer::class);
